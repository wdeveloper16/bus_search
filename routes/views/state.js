...
exports = module.exports = function (req, res) {
	...
	locals.breadcrumbs = [{url:"/bundesland/"+locals.name, name: locals.name}];
	...
	view.on('init', function(next) {
		...
		q.exec(function(err, results) {
			...
			var name = results.results[0].location.state;
			...
			locals.breadcrumbs = [{url:"/bundesland/"+locals.name, name: name}];
